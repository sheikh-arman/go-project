...
const (
	HelloWorldService_SayHello_FullMethodName = "/proto.HelloWorldService/SayHello"
)
...
type HelloWorldServiceClient interface {
	SayHello(ctx context.Context, in *RequestHelloWorld, opts ...grpc.CallOption) (*ResponseHelloWorld, error)
}
...
func (c *helloWorldServiceClient) SayHello(ctx context.Context, in *RequestHelloWorld, opts ...grpc.CallOption) (*ResponseHelloWorld, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseHelloWorld)
...
type HelloWorldServiceServer interface {
	SayHello(context.Context, *RequestHelloWorld) (*ResponseHelloWorld, error)
...
func (UnimplementedHelloWorldServiceServer) SayHello(context.Context, *RequestHelloWorld) (*ResponseHelloWorld, error) {
...
func _HelloWorldService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServiceServer).SayHello(ctx, req.(*RequestHelloWorld))
	}
